...
public class StaticObject {
    ...
    public StaticObject(GridPoint2 initialCoordinates, float rotation, TypeGameObjects type) {
        this.position = new Position(initialCoordinates, rotation, type);
    }
    public StaticObject(GridPoint2 initialCoordinates, TypeGameObjects type) {
