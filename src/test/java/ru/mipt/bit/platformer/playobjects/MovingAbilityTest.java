...
class MovingAbilityTest {
    ...
    void changeMovementProgress() {
        ...
        assertEquals(movingAbility.getMovementProgress(), 0f, "Wrong movement progress after creation!");
        ...
        assertEquals(movingAbility.getMovementProgress(), 1f, "Wrong movement progress after changing!");
    }
}
